...
async def test_host_only_csrf_can_be_recovered_only_through_authenticated_api(client):
    ...
    assert recovered.json()["data"]["csrf_token"] == client.cookies.get("buili_csrf")
